...
$(".submit-reorder").click(function() {	
	...
	if ( typeof( window[ 'reorderData' ] ) != "undefined" ) {
		$('span.reorder-loading').show().html('<img src="../wp-content/themes/antioch/lib/admin/reorder/loading.gif" />');
	
		$.post('../wp-content/themes/antioch/lib/admin/reorder/process-sortable.php', reorderData, function(data) {
