...
function ct_theme_options_do_page() {
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<?php $main_color = $options['main_color']; if(empty($main_color) || $main_color == '#'): $options['main_color'] = '#629fa6'; endif; ?>

			<table class="form-table churchthemes">
				<tr>
					<th scope="row"><?php _e( 'Main Color', 'churchthemes' ); ?></th>
					<td class="option">
						<input id="ct_theme_options[main_color]" class="color" type="text" name="ct_theme_options[main_color]" placeholder="#629fa6" value="<?php esc_attr_e( $options['main_color'] ); ?>" />
					...
					<td class="info">
						...
						<p><em><?php _e( 'If blank, "#629fa6" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
...
<?php endif; ?>
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_width]" class="regular-text" type="text" name="ct_theme_options[logo_width]" placeholder="277" value="<?php esc_attr_e( $options['logo_width'] ); ?>" />
					</td>
					<td class="info">
						<p><?php _e( 'Enter a custom width (in pixels) for your logo image.', 'churchthemes' ); ?></p>
						<p><em><?php _e( 'If blank, "277" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_height]" class="regular-text" type="text" name="ct_theme_options[logo_height]" placeholder="25" value="<?php esc_attr_e( $options['logo_height'] ); ?>" />
					</td>
					<td class="info">
						<?php _e( 'Enter a custom height (in pixels) for your logo image.', 'churchthemes' ); ?></p>
						<p><em><?php _e( 'If blank, "25" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_top_margin]" class="regular-text" type="text" name="ct_theme_options[logo_top_margin]" placeholder="32" value="<?php esc_attr_e( $options['logo_top_margin'] ); ?>" />
					</td>
					<td class="info">
						<p><?php _e( 'Enter a custom top margin (in pixels) for your logo image.', 'churchthemes' ); ?></p>
						<p><em><?php _e( 'If blank, "32" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
