<?php
	...
	if(empty($ct_main_color) || $ct_main_color == '#'): $ct_main_color = '#f08d24'; endif;
	
	$ct_logo = $theme_options['logo'];
	
	$ct_logo_width = $theme_options['logo_width'];
	if(empty($ct_logo_width)): $ct_logo_width = '209'; endif;
	
	$ct_logo_height = $theme_options['logo_height'];
	if(empty($ct_logo_height)): $ct_logo_height = '56'; endif;
	
	$ct_logo_top_margin = $theme_options['logo_top_margin'];
	if(empty($ct_logo_top_margin)): $ct_logo_top_margin = '50'; endif;
