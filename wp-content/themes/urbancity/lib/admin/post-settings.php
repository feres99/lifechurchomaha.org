		...
		<form method="post" action="options.php">
			...
			<table class="form-table churchthemes">
						...
						<?php
							...
							foreach ( $radio_order as $option ) {
								...
								<label class="description">
									<input type="radio" name="ct_post_settings[order]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?>
								</label>
								<br />
								<?php
							}
				...
				<tr>
					...
					<td class="option">
						<input id="ct_post_settings[archive_title]" class="regular-text" type="text" name="ct_post_settings[archive_title]" placeholder="<?php _e( 'Post Archives', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['archive_title'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_post_settings[archive_tagline]" class="regular-text" type="text" name="ct_post_settings[archive_tagline]" placeholder="<?php _e( 'e.g. All the latest news', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['archive_tagline'] ); ?>" />
					</td>
					<td class="info">
					...
					<td class="option">
						...
						<?php
							...
							foreach ( $radio_toggle as $option ) {
								...
								?>
								<label class="description">
									<input type="radio" name="ct_post_settings[facebook_likes]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?>
								</label>
								<br />
								<?php
							}
					...
					<td class="option">
						...
						<?php
							...
							foreach ( $radio_toggle as $option ) {
								...
								?>
								<label class="description">
									<input type="radio" name="ct_post_settings[tweet_this]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?>
								</label>
								<br />
								<?php
							}
