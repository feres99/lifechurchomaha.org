...
$(".submit-reorder").click(function() {	
	...
	if ( typeof( window[ 'reorderData' ] ) != "undefined" ) {
		$('span.reorder-loading').show().html('<img src="../wp-content/themes/urbancity/lib/admin/reorder/loading.gif" />');
	
		$.post('../wp-content/themes/urbancity/lib/admin/reorder/process-sortable.php', reorderData, function(data) {
