...
/**
 * Custom Sidebars
 * Last update Jun 7, 2011
 */

define('CT_ADMIN', get_bloginfo('template_directory') . '/lib/admin');
...
function sidebar_admin_menu() {
	add_theme_page('Sidebars', 'Sidebars', 'edit_themes', 'sidebars', 'sidebar_admin_page');
}
...
// Register other default sidebar areas
