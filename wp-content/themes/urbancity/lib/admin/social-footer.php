...
function ct_social_footer_settings_add_page() {
	add_submenu_page('themes.php', __( 'Social Footer', 'churchthemes' ), __( 'Social Footer', 'churchthemes' ), 'edit_themes', 'social-footer', 'ct_social_footer_settings_do_page');
}
		...
		<form method="post" action="options.php">
			...
			<table class="form-table churchthemes">
					...
					<td class="option">
						<fieldset>
							...
							<label class="description">
								<input type="radio" name="ct_social_footer_settings[social_footer]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php echo $checked; ?> /> <?php echo $option['label']; ?>
							</label>
							<br />
							<?php
								}
				...
				<tr>
					...
					<td class="option">
						<input id="ct_social_footer_settings[title]" class="regular-text" type="text" name="ct_social_footer_settings[title]" placeholder="<?php _e( 'e.g. Connect With Us', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['title'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_social_footer_settings[facebook]" class="regular-text" type="text" name="ct_social_footer_settings[facebook]" placeholder="<?php _e( 'e.g. http://www.facebook.com/yourchurch', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['facebook'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_social_footer_settings[twitter]" class="regular-text" type="text" name="ct_social_footer_settings[twitter]" placeholder="<?php _e( 'e.g. http://twitter.com/yourchurch', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['twitter'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_social_footer_settings[flickr]" class="regular-text" type="text" name="ct_social_footer_settings[flickr]" placeholder="<?php _e( 'e.g. http://www.flickr.com/photos/yourchurch', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['flickr'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_social_footer_settings[youtube]" class="regular-text" type="text" name="ct_social_footer_settings[youtube]" placeholder="<?php _e( 'e.g. http://www.youtube.com/yourchurch', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['youtube'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_social_footer_settings[vimeo]" class="regular-text" type="text" name="ct_social_footer_settings[vimeo]" placeholder="<?php _e( 'e.g. http://vimeo.com/yourchurch', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['vimeo'] ); ?>" />
					</td>
					<td class="info">
