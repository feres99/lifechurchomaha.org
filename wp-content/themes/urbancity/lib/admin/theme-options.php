...
// <-- Check to see if you are on the right page
...
function ct_theme_options_do_page() {
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<?php $main_color = $options['main_color']; if(empty($main_color) || $main_color == '#'): $options['main_color'] = '#f08d24'; endif; ?>

			<table class="form-table churchthemes">
				<tr>
					<th scope="row"><?php _e( 'Main Color', 'churchthemes' ); ?></th>
					<td class="option">
						<input id="ct_theme_options[main_color]" class="color" type="text" name="ct_theme_options[main_color]" placeholder="#f08d24" value="<?php esc_attr_e( $options['main_color'] ); ?>" />
					...
					<td class="info">
						...
						<p><em><?php _e( 'If blank, "#f08d24" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
				...
				<tr class="top">
					...
					<td class="option">
						<input id="ct_theme_options[logo]" class="regular-text" type="text" name="ct_theme_options[logo]" value="<?php esc_attr_e( $options['logo'] ); ?>" />
						<input id="upload_logo" type="button" class="button" value="Upload Image" />
<?php if($options['logo']): ?>
						<br />
						<img src="<?php esc_attr_e( $options['logo'] ); ?>" class="preview" />
<?php endif; ?>
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_width]" class="regular-text" type="text" name="ct_theme_options[logo_width]" placeholder="209" value="<?php esc_attr_e( $options['logo_width'] ); ?>" />
					</td>
					<td class="info">
						<p><?php _e( 'Enter a custom width (in pixels) for your logo image.', 'churchthemes' ); ?></p>
						<p><em><?php _e( 'If blank, "209" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_height]" class="regular-text" type="text" name="ct_theme_options[logo_height]" placeholder="56" value="<?php esc_attr_e( $options['logo_height'] ); ?>" />
					</td>
					<td class="info">
						<?php _e( 'Enter a custom height (in pixels) for your logo image.', 'churchthemes' ); ?></p>
						<p><em><?php _e( 'If blank, "56" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[logo_top_margin]" class="regular-text" type="text" name="ct_theme_options[logo_top_margin]" placeholder="50" value="<?php esc_attr_e( $options['logo_top_margin'] ); ?>" />
					</td>
					<td class="info">
						<p><?php _e( 'Enter a custom top margin (in pixels) for your logo image.', 'churchthemes' ); ?></p>
						<p><em><?php _e( 'If blank, "50" will be used by default.', 'churchthemes' ); ?></em></p>
					</td>
				</tr>
				...
				<tr class="top">
					...
					<td class="option">
						<input id="ct_theme_options[favicon]" class="regular-text" type="text" name="ct_theme_options[favicon]" value="<?php esc_attr_e( $options['favicon'] ); ?>" />
						<input id="upload_favicon" type="button" class="button" value="Upload Image" />
<?php if($options['favicon']): ?>
						<br />
						<img src="<?php esc_attr_e( $options['favicon'] ); ?>" class="preview" />
<?php endif; ?>
					</td>
					<td class="info">
				...
				<tr class="top">
					...
					<td class="option">
						<input id="ct_theme_options[ios_icon]" class="regular-text" type="text" name="ct_theme_options[ios_icon]" value="<?php esc_attr_e( $options['ios_icon'] ); ?>" />
						<input id="upload_ios_icon" type="button" class="button" value="Upload Image" />
<?php if($options['ios_icon']): ?>
						<br />
						<img src="<?php esc_attr_e( $options['ios_icon'] ); ?>" class="preview" />
<?php endif; ?>
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[search_results_title]" class="regular-text" type="text" name="ct_theme_options[search_results_title]" placeholder="<?php _e( 'Search Results', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['search_results_title'] ); ?>" />
					</td>
					<td class="info">
				...
				<tr>
					...
					<td class="option">
						<input id="ct_theme_options[footer_copyright_text]" class="regular-text" type="text" name="ct_theme_options[footer_copyright_text]" placeholder="<?php _e( 'e.g. Copyright &copy; ' . date('Y') . ' ' . get_bloginfo('name') . ' | All rights reserved.', 'churchthemes' ); ?>" value="<?php esc_attr_e( $options['footer_copyright_text'] ); ?>" />
					</td>
					<td class="info">
...
function ct_theme_options_validate( $input ) {
	...
	if ( ! isset( $input['select1'] ) || ! array_key_exists( $input['select1'], $select_layout ) )
		$input['select1'] = null;
